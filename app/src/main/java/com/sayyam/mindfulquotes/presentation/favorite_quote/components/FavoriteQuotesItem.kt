package com.sayyam.mindfulquotes.presentation.favorite_quote.components
...
import com.sayyam.mindfulquotes.presentation.favorite_quote.FavoriteQuotesEvent

@Composable
fun FavoriteQuotesItem(
    quote: QuoteEntity,
    onEvent: (FavoriteQuotesEvent) -> Unit,
            ...
            Column(
                ...
                Icon(
                    ...
                    modifier = Modifier
                        ...
                        .size(30.dp)
                        .clickable {
                            onEvent(FavoriteQuotesEvent.OnLikeChange(quote))
                        }
                )
            }
        }
